...
<form name="frm" method="post" action="/admin/product_write" enctype="multipart/form-data"> 
<table id="list">
<tr>
  <th>상품분류</th>
  <td colspan="5">
...
<tr>
  ...
  <td width="343" colspan="5">
       <input type="text" name="name" size="47" maxlength="100" placeholder="상품명입력..">
  </td>
</tr>
<tr>
  <th>원가[A]</th>
  <td width="70">
    <input type="text" name="price1" size="11" onKeyUp='NumFormat(this)' placeholder="원가입력..">
  </td>
  <th>판매가[B]</th>
  <td width="70">
  ...
  <tr>
    <th>상세설명</th>
    <td colspan="5">
      <textarea name="content" rows="8" cols="70" placeholder="설명입력.."></textarea>
    </td>
  </tr>
  <tr>
    <th>상품이미지</th>
