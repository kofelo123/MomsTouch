...
<%@ include file="sub_menu.jsp" %>       
  ...
  <div class="paginate">
		...
		<img src='images/momstouch/paginate/btn_pre.gif' alt='이전'></a>&nbsp;&nbsp;<strong>1</strong>&nbsp;
		
		<a href="NonageServlet?command=catagory2&kind=${kindpage}">2</a>&nbsp;
		<a href='NonageServlet?command=catagory3&kind=${kindpage}'>3</a>&nbsp;&nbsp;
		
		<a href="NonageServlet?command=catagory2&kind=${kindpage}" class='page_next' onfocus='this.blur()'>
