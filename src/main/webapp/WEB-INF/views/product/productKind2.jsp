...
<%@ include file="sub_menu.jsp" %>       
  ...
  <div class="paginate">
		...
		<a href='NonageServlet?command=catagory&kind=${kindpage}' class='page_pre' onfocus='this.blur()'>
		<img src='images/momstouch/paginate/btn_pre.gif' alt='이전'></a>&nbsp;&nbsp;
		
		<a href="NonageServlet?command=catagory&kind=${kindpage}">1</a>&nbsp;
		
		<strong>2</strong>&nbsp;
		<a href='NonageServlet?command=catagory3&kind=${kindpage}'>3</a>&nbsp;&nbsp;
		
		<a href="NonageServlet?command=catagory3&kind=${kindpage}" class='page_next' onfocus='this.blur()'>
		<img src='images/momstouch/paginate/btn_next.gif' alt='다음' /></a>&nbsp;
		
		<a href='NonageServlet?command=catagory3&kind=${kindpage}'	class='page_end' onfocus='this.blur()'>
