 ...
 <div class="container">
			...
			<div id="da-slider" class="da-slider">
				...
				<div class="da-slide">
					...
					<a href="/product/product_detail&pseq=33" class="da-link">메뉴보기</a>
					<div class="da-img"><img src="/resources/rolling/images/2.png" alt="image02" /></div>
				</div>
				<div class="da-slide">
					<h2>데리야끼 윙</h2>
					<p>신선한 닭날개에 매운맛과 순한맛의 데리야끼 소스를 가미하여 양념이 손에 묻지 않고 ,편하게 드실 수 있는 고급 윙메뉴</p>
					<a href="/product/product_detail&pseq=15" class="da-link">메뉴보기</a>
					<div class="da-img"><img src="/resources/rolling/images/3.png" alt="image03" /></div>
				</div>
				<!-- <div class="da-slide">
					<h2>Quality Control</h2>
					<p>Even the all-powerful Pointing has no control about the blind texts it is an almost unorthographic life One day however a small line of blind text by the name of Lorem Ipsum decided to leave for the far World of Grammar.</p>
					<a href="#" class="da-link">Read more</a>
					<div class="da-img"><img src="/resources/rolling/images/4.png" alt="image04" /></div>
				</div> -->
				<nav class="da-arrows">
  ...
  <div id="front">   
    ...
    <div id="bestProduct">         
      <c:forEach items="${listNewProduct }"  var="productVO">
        <div id="item">
          <a href=
"/product/product_detail&pseq=${productVO.pseq}">
